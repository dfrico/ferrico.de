...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = exports.Main = function (_React$Component) {
		...
		_createClass(Main, [{
			...
			key: 'updateUserData',
			value: function updateUserData(obj) {
				var updatedData = Object.assign(_lodash2.default.cloneDeep(this.state.userData), obj);
				if (updatedData.id) {
					console.log(updatedData);
				} else this.setStore({ userData: updatedData });
			}
		}, {
